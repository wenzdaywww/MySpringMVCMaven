...
public class CodeUtils {
	...
	public static void main(String[] args) {
		System.out.println(CodeUtils.produce16MD5("www"));
		System.out.println(CodeUtils.produce32MD5("www"));
		System.out.println("字符串加密后="+CodeUtils.encrypt("www123", "123456"));
		System.out.println("字符串解密后="+CodeUtils.decrypt("www123", CodeUtils.encrypt("www123", "123456")));
	}
	/**
	 * 32位MD5加密
	 * @param code
