...
//		ExecuteCMDUtils.produceJDKWebServiceClientFiles("D:\\ProgramFiles\\Genuitec\\WorkSpaces\\work_www\\test\\Demo\\src", 
//				"com.www.app.webclient.producebyjdk", "http://localhost:8080/demo/services/AxisService?wsdl");
		ExecuteCMDUtils.produceAxis2WebServiceClientFiles("D:\\ProgramFiles\\WorkSpaces\\myeclipse\\work_www\\MavenDemo",
				"main.java.com.www.app.webservice.axis2client", "http://localhost:8080/maven/services/AxisService?wsdl");
	}
	/**
	 * 执行cmd指令
	 * @param name cmd指令
